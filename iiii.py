...
TOKEN = '8279997071:AAFT98o8RFN1y0IxvZqccvCKVLzhmf36BSc' #توكنك بوت بدل كلمه token
ADMIN_ID = 6288167218  # ايديك حسابك التلي بدل كلمه ID
channel = '@QT_S2' #يوزر قناتك هنا مو الرابط

# ممنوع تغيير المصدر @Abdm39
...
def ask_for_subscription(chat_id):
    ...
    join_button = types.InlineKeyboardButton('📢 اشترك في القناة', url=f'https://t.me/adoatt1')
...
def send_welcome(message):
    ...
    dev_channel_button = types.InlineKeyboardButton('🔧 قناة المطور', url='https://t.me/adoatt1')
...
# لا تغير الحقوق يا فاشل زلم تعبت بيها @Abdm39
# تنشر اذكر المصدر
#ممنوع تغيير الحقوق
#غير مسوول عن اي تعديل داخل الادات teaegram@abdm39
